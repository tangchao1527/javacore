...
public class QRDimensionCode {
	...
	public static String decoderQRCode(String imgPath) throws Exception{
		...
		try {
			...
			content = new String(decoder.decode(new QRimensionCodeImage(
					bufImg)), "utf-8");
		} catch (IOException e) {
			e.printStackTrace();
	...
	public static void main(String[] args) throws Exception {
		...
		QRDimensionCode handler = new QRDimensionCode();
		//QRDimensionCode.encoderQRCode(encoderContent, imgPath, "png");

		System.out.println("========encoder success");
		String decoderContent = QRDimensionCode.decoderQRCode(imgPath);
