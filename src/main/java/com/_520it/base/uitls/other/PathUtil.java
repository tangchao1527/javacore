...
public class PathUtil {
	...
	public static String getRootPath(){
		String classResources = PathUtil.getClassResources();
		return classResources.substring(0, classResources.indexOf("WEB-INF"))+"WEB-INF/";
	}
	public static String getWebApp(){
		String classResources = PathUtil.getClassResources();
		return classResources.substring(0, classResources.indexOf("WEB-INF"));
	}
